...
public class ParkingSlotDetails {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(vehicleParkingTime, that.vehicleParkingTime) && Objects.equals(vehicleNumber,
                that.vehicleNumber) && vehicleSize == that.vehicleSize && driverType == that.driverType && vehicleColor == that.vehicleColor && vehicleMake == that.vehicleMake;
    }

    @Override
    public int hashCode() {
        return Objects.hash(vehicleParkingTime, vehicleNumber, vehicleSize, driverType, vehicleColor, vehicleMake);
    }
}
